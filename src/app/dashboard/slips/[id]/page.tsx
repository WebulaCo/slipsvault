        ...
        <div className="min-h-screen bg-brand-light text-gray-900 p-4 pb-24">
            ...
            <div className="space-y-4">
                <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                    <label className="text-gray-500 text-sm block mb-1">Merchant</label>
                    <div className="font-bold text-lg text-brand-navy">{slip.title}</div>
                </div>
                ...
                <div className="bg-white rounded-xl p-4 space-y-4 shadow-sm border border-gray-100">
                    <div className="flex justify-between items-center border-b border-gray-100 pb-4">
                        ...
                        <span className="font-medium text-gray-900">{slip.date ? new Date(slip.date).toLocaleDateString() : '-'}</span>
                    </div>
